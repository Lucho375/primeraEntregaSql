...
CREATE TABLE IF NOT EXISTS `workshop`.`workshop` (
  ...
  CONSTRAINT `fk_workshop_user_id`
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `workshop`.`customer` (
  ...
  CONSTRAINT `fk_customer_workshop_id`
...
CREATE TABLE IF NOT EXISTS `workshop`.`vehicle` (
  ...
  CONSTRAINT `fk_vehicle_customer_id`
...
CREATE TABLE IF NOT EXISTS `workshop`.`work_order` (
  ...
  CONSTRAINT `fk_work_order_vehicle_id`
    FOREIGN KEY (`vehicle_id`)
    REFERENCES `workshop`.`vehicle` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_work_order_mechanic_id`
    FOREIGN KEY (`mechanic_id`)
    REFERENCES `workshop`.`mechanic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `workshop`.`invoice` (
  ...
  CONSTRAINT `fk_invoice_work_order_id`
